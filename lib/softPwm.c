...
static volatile int mode          [MAX_PINS] ;  //DC, Step Motor
...
int softPwmCreate (int pin, int initialValue, int pwmRange, int motor)
{
  int res ;
  pthread_t myThread ;
