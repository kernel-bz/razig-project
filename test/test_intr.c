...
int main (void)
{
  ...
  */
  ...
  wiringPiISR (22, INT_EDGE_FALLING, &myInterrupt0) ;	//P31
  wiringPiISR (23, INT_EDGE_FALLING, &myInterrupt1) ;	//P33
  wiringPiISR (24, INT_EDGE_FALLING, &myInterrupt2) ;	//P35
  wiringPiISR (25, INT_EDGE_FALLING, &myInterrupt3) ;	//P37
  wiringPiISR (27, INT_EDGE_FALLING, &myInterrupt4) ;	//P36
